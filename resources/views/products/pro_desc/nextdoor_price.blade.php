...
<style>
  .product-image {
    background: linear-gradient(to bottom,rgb(24, 150, 24) 0%, #2c1011  100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(24, 150, 24) 0%, #2c1011  100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, #2c1011 0%, rgb(24, 150, 24) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/nextdoor_poster.png')}}" alt="" class="product-pic">
