...
<title>Buy Varified Outlook Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(30, 106, 248) 0%, rgb(1, 42, 104) 100%);
  }
  .footer >a > button {
    background: linear-gradient(to bottom, rgb(30, 106, 248) 0%, rgb(1, 42, 104) 100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(1, 42, 104) 0%, rgb(30, 106, 248) 100%);
  }
  .product-details .price .current,
  .product-details .rate a.active, .product-details .rate a:hover{
    color: rgb(30, 106, 248);
  }
</style>
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/outlook_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Get freshly created Outlook accounts with credentials delivered straight to your email. Enjoy a 3-day replacement guarantee and 24/7 support for a hassle-free experience.</p>
    </article>
