...
<title>Buy Varified Paxful Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(121, 1, 219) 0%, rgb(27, 1, 49) 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(121, 1, 219) 0%, rgb(27, 1, 49) 100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(27, 1, 49) 0%, rgb(121, 1, 219) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/paxful_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Looking for Paxful accounts? We've got you covered! Receive your purchased account details via email. 
        Enjoy fresh Paxful accounts with a 3-day replacement policy and 24/7 support.</p>
    </article>
