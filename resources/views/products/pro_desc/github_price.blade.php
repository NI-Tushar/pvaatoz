...
<title>Buy Varified Github Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, #c5c5c5 0%, #4e4e4e 100%);
  }
  .footer > a > button {
    background: linear-gradient(to bottom, #cfcece 0%, #4e4e4e 100%);
    box-shadow: 0 10px 30px 0 rgba(109, 109, 109, 0.7);
  }
  .footer > a> button:hover {
    background: linear-gradient(to bottom, #4e4e4e 0%, #cfcece 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/github_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Receive newly created GitHub accounts with credentials delivered straight to your email. Enjoy a 3-day replacement guarantee and round-the-clock support for a seamless experience.</p>
    </article>
