...
<title>Buy Varified Yahoo Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, #8825f8 0%, #2d025f 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, #6802dd 0%, #8825f8 100%);
    box-shadow: 0 10px 30px 0  rgba(60, 4, 112, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom, #2d025f 0%, #6802dd 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/yahoo_poster.png')}}" alt="" class="product-pic">
