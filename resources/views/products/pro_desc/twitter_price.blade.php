...
<title>Buy Varified Twitter Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, #47a5f1 0%, #004483 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, #47a5f1 0%, #004483 100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, #004483 0%, #47a5f1 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/twitter_poster.png')}}" alt="" class="product-pic">
