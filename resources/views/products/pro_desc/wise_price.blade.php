...
<title>Buy Varified Wise Account | PVAATOZ</title>
@endpush
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/wise_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Receive created Wise accounts, with credentials sent directly to your email. Enjoy a 3-day replacement guarantee and 24/7 support to ensure your satisfaction.</p>
    </article>
