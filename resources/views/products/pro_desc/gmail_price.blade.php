...
<title>Buy Varified Gmail Account | PVAATOZ</title>
@endpush
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/gmail_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Gmail accounts created recently in 2024. We will provide a list of your purchased account credentials to your email. Fresh Gmail accounts. We also offer a 3-day replacement guarantee and 24-hour support.</p>
    </article>
