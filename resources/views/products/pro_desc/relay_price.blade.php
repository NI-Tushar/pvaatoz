...
<title>Buy Varified Relay Business Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(0, 117, 133) 0%, rgb(0, 51, 44) 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(0, 117, 133) 0%, rgb(0, 51, 44) 100%);
    box-shadow: 0 10px 30px 0 rgba(1, 77, 139, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(0, 51, 44) 0%, rgb(0, 117, 133) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/relay_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Looking for Twitter accounts? We've got you covered! Receive your purchased account details via email. Enjoy fresh Twitter accounts with a 3-day replacement policy and round-the-clock support.</p>
    </article>
