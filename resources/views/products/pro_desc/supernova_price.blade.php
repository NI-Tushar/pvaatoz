...
<title>Buy Varified Supernova Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom,rgb(255, 212, 8)0%,rgb(49, 41, 1)  100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom,rgb(255, 212, 8) 0%,rgb(9, 9, 9)  100%);
    box-shadow: 0 10px 30px 0 rgba(2, 45, 53, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom,rgb(255, 212, 8) 0%,rgb(55, 38, 0) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/supernova_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Supernova accounts come with login details sent directly to your email. 
