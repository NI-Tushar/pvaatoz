...
<title>Buy Varified Airchat Account | PVAATOZ</title>
@endpush
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/airchat_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Airchat accounts come with login details sent directly to your email. 
