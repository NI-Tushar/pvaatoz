...
<title>Buy Varified Trustpilot Reviews | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(4, 218, 141) 0%,rgb(0, 45, 36)  100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(4, 218, 141) 0%, rgb(0, 45, 36)   100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(0, 45, 36)  0%, rgb(4, 218, 141) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/trustpilot_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Trustpilot Reviewss come with login details sent directly to your email. 
