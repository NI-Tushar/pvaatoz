...
<title>Buy Varified Console Play Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom,rgb(66, 143, 218) 0%, #2c1011  100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(66, 143, 218) 0%, #2c1011  100%);
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/console_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Console Play accounts come with login details sent directly to your email. 
