...
<title>Buy Varified Review Mail Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(1, 132, 255) 0%, rgb(0, 44, 85) 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(1, 132, 255) 0%, rgb(0, 44, 85) 100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(0, 44, 85) 0%, rgb(1, 132, 255) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/review_mail_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Obtain set-up Review Mail accounts, with credentials sent to your email. Take advantage of our 3-day replacement guarantee and 24/7 support for a hassle-free experience.</p>
    </article>
