...
<title>Buy Varified Tinder Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(252, 48, 160)0%, rgb(126, 4, 71) 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(252, 48, 160)0%, rgb(126, 4, 71) 100%);
    box-shadow: 0 10px 30px 0 rgba(2, 53, 13, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(126, 4, 71) 0%, rgb(252, 48, 160) 100%);
  }
  .product-details .price .current,
  .product-details .rate a.active, .product-details .rate a:hover{
    color: rgb(252, 48, 160);
  }
</style>
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/tinder_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Secure newly created Tinder accounts with credentials sent straight to your email. Take advantage of a 3-day replacement guarantee and round-the-clock support for a smooth experience.</p>
    </article>
