...
<title>Buy Varified AliExpress Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom,rgb(231, 56, 0) 0%, #2c1011  100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(231, 56, 0) 0%, #2c1011  100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, #2c1011 0%, rgb(231, 56, 0) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/aliexpress_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>AliExpress accounts come with login details sent directly to your email. 
