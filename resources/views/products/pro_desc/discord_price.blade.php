...
<title>Buy Varified Discord Account | PVAATOZ</title>
@endpush
...
<style>
  ...
  .footer > a > button {
    background: linear-gradient(to bottom, rgb(1, 132, 255) 0%, rgb(0, 44, 85) 100%);
    box-shadow: 0 10px 30px 0 rgba(1, 33, 102, 0.7);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/discord_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Obtain set-up Discord accounts, with credentials sent to your email. Take advantage of our 3-day replacement guarantee and 24/7 support for a hassle-free experience.</p>
    </article>
