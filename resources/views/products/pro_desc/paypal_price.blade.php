...
<title>Buy US Varified PayPal Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(0, 126, 194) 0%, rgb(0, 22, 63)  100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(0, 126, 194) 0%, rgb(0, 22, 63)  100%);
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/paypal_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>PayPal accounts come with credentials sent directly to your email. Enjoy a 3-day replacement guarantee and 24/7 support for a seamless experience.</p>
    </article>
