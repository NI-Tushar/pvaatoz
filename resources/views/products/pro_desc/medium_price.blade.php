...
<title>Buy Varified Medium Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(212, 212, 212) 0%, rgb(85, 85, 85) 100%);
  }
  .footer > a >  button {
    background: linear-gradient(to bottom,  rgb(212, 212, 212) 0%, rgb(85, 85, 85) 100%);
    box-shadow: 0 10px 30px 0 rgba(43, 43, 43, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(85, 85, 85) 0%, rgb(212, 212, 212) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/medium_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Get Medium accounts, with login details sent directly to your inbox. Benefit from a 3-day replacement guarantee and round-the-clock support for a smooth setup.</p>
    </article>
