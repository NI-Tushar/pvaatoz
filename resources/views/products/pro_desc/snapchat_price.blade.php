...
<title>Buy Varified Snapchat Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(248, 224, 9) 0%, #8d8401 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, #f0c403 0%, #7c7001 100%);
    box-shadow: 0 10px 30px 0 rgba(255, 220, 107, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom, #7c7001 0%, #f0c403 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/snapchat_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>New Snapchat accounts created in 2024. We'll send the account credentials you purchase directly to your email. Our Snapchat accounts are freshly made, and we offer a 3-day replacement guarantee along with 24/7 support.</p>
    </article>
