...
<title>Buy Varified Ticketmaster Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(3, 163, 236) 0%, rgb(1, 81, 128) 100%);
  }
  .footer > a> button {
    background: linear-gradient(to bottom, rgb(3, 163, 236) 0%, rgb(1, 81, 128) 100%);
    box-shadow: 0 10px 30px 0 rgba(12, 60, 122, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(1, 81, 128) 0%, rgb(3, 163, 236) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/ticketmaster_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Obtain newly created Ticketmaster accounts with credentials sent directly to your email. Take advantage of our 3-day replacement guarantee and 24/7 support for a smooth and worry-free experience.</p>
    </article>
