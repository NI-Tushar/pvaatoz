...
<title>Buy Varified Edu Mail Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, #d1e8fc 0%, #7e8081 100%);
  }
  .footer > a > button {
    background: linear-gradient(to bottom, #d1e8fc 0%, #7e8081 100%);
    box-shadow: 0 10px 30px 0 rgba(114, 116, 117, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom, #7e8081 0%, #d1e8fc 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/edumail_poster.jpeg')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Obtain freshly created Edu-mail accounts with credentials sent directly to your email. Enjoy a 3-day replacement guarantee and 24/7 support for a seamless experience.</p>
    </article>
