...
<title>Buy Varified Pinterest Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, #fc5a4e, 9) 0%, #660700 100%);
  }
  .footer >a > button {
    background: linear-gradient(to bottom, #fc5a4e 0%, #660700 100%);
    box-shadow: 0 10px 30px 0 rgba(255, 220, 107, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom, #660700 0%, #fc5a4e 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/pinterest_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Acquire newly created Pinterest accounts with credentials delivered directly to your email. Enjoy a 3-day replacement guarantee and 24/7 support for a hassle-free experience.</p>
    </article>
