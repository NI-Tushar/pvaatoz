...
<title>Buy Varified Bereal Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom,rgb(255, 255, 255) 0%,rgb(45, 45, 45)  100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom,rgb(255, 255, 255) 0%,rgb(9, 9, 9)  100%);
    box-shadow: 0 10px 30px 0 rgba(2, 45, 53, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom,rgb(2, 2, 2) 0%,rgb(244, 244, 244) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/bereal_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Bereal accounts come with login details sent directly to your email. 
