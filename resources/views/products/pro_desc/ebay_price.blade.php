...
<title>Buy Varified eBay Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(223, 56, 64) 0%, rgb(32, 4, 13) 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(223, 56, 64)  0%, rgb(32, 4, 13)  100%);
    box-shadow: 0 10px 30px 0  rgba(60, 4, 112, 0.7);
  }
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(32, 4, 13)  0%, rgb(223, 56, 64) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/ebay_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>eBay accounts come with login details delivered straight to your email. Enjoy a 3-day replacement guarantee and 24/7 support for a hassle-free experience.</p>
    </article>
