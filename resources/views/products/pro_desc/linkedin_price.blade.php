...
<title>Buy Varified Linked-in Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, #2556f8 0%, #001558 100%);
  }
  .footer > a > button {
    background: linear-gradient(to bottom, #2556f8 0%, #001558 100%);
  ...
  .footer > a > button:hover {
    background: linear-gradient(to bottom, #001558 0%, #2556f8 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/linkedin_poster.png')}}" alt="" class="product-pic">
    ...
    <div class="product-details">
      <header>
        <h1 class="title"><span id="quantity">{{$qty}}</span><span id="pro_name"> <?php echo $pro_name;?></h1>
    ...
    <article>
      <h5>Description</h5>
      <p>Created LinkedIn accounts. Your purchased account credentials will be emailed to you. Fresh LinkedIn accounts. We provide a 3-day replacement guarantee and 24-hour support.</p>
    </article>
