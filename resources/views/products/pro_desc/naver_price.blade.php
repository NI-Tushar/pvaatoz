...
<title>Buy Varified Naver Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(68, 165, 60)0%, rgb(2, 94, 14) 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(68, 165, 60)0%, rgb(2, 94, 14) 100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(2, 94, 14) 0%, rgb(68, 165, 60) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/naver_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Receive fresh Naver accounts with login details delivered straight to your email. Benefit from our 3-day replacement guarantee and 24/7 support for a seamless setup.</p>
    </article>
