...
<title>Buy Varified Payoneer Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(218, 44, 0) 0%, rgb(59, 12, 0)  100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(218, 44, 0) 0%, rgb(59, 12, 0)  100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(59, 12, 0) 0%, rgb(218, 44, 0) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/payoneer_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Payoneer accounts come with credentials sent directly to your email. Benefit from a 3-day replacement guarantee and 24/7 support for a smooth and hassle-free experience.</p>
    </article>
