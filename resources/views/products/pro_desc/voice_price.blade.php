...
<title>Buy Varified Google Voice Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(34, 158, 111) 0%, rgb(2, 39, 25)  100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(34, 158, 111) 0%, rgb(2, 39, 25) 100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(2, 39, 25) 0%, rgb(34, 158, 111) 100%);
  }
  .product-details .price .current,
  .product-details .rate a.active, .product-details .rate a:hover{
    color: rgb(34, 158, 111);
  }
</style>
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/voice_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Obtain newly created Google Voice accounts with credentials sent to your email. Take advantage of a 3-day replacement guarantee and 24/7 support for a hassle-free experience.</p>
    </article>
