...
<title>Buy Varified Stake Account | PVAATOZ</title>
@endpush
...
<style>
  .product-image {
    background: linear-gradient(to bottom, rgb(0, 96, 145) 0%, rgb(3, 22, 31) 100%);
  }
  .footer >a> button {
    background: linear-gradient(to bottom, rgb(0, 96, 145) 0%, rgb(3, 22, 31) 100%);
  ...
  .footer >a> button:hover {
    background: linear-gradient(to bottom, rgb(3, 22, 31) 0%, rgb(0, 96, 145) 100%);
  }
...
<div class="pro_desc">
  ...
  <div class="container">
    ...
    <div class="product-image">
      ...
      <img  src="{{url('resource/images/product_poster/stake_poster.png')}}" alt="" class="product-pic">
    ...
    <article>
      <h5>Description</h5>
      <p>Looking for Stake accounts? We've got you covered! Receive your purchased account details via email. 
        Enjoy fresh Stake accounts with a 3-day replacement policy and 24/7 support.</p>
    </article>
